...
class Images extends CRUD {
    ...
    public function validationImagePrincipale($image){
        ...
        if ($image['error'] !== UPLOAD_ERR_OK) {
            ...
            if(!in_array($extension, $extensionsAcceptees)){
                $message = "Le type d'extension de l'image principale n'est pas supportées par le système.";
                array_push($erreursImage, $message);
            }
        }
         //Retour
