...
const affichageCoupCoeurLord = async () => {
  ...
  section.className = "coup-coeur-lord";
  ...
  contenu.className = "coup-coeur-lord__contenu";
  section.appendChild(contenu);

  // Image lord
  const picture = document.createElement("picture");
  picture.className = "coup-coeur-lord__image";
  ...
  let catalogueCoupCoeur = new Catalogue(encheres, galerie);
